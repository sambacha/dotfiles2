...
cfgname=".cfg";
bkpname="backup.cfg";
gitrepo="git@github.com:sambacha/dotfiles2.git";
gitrepo_ro="git://github.com/sambacha/dotfiles2.git";
  ...
  then 
    if [[ -z $(command -v git) ]]
      then
        ...
        curl -LsO https://github.com/sambacha/dotfiles2/archive/master.tar.gz
